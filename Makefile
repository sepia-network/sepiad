...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=sepia \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=sepiad \
		  -X github.com/cosmos/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X github.com/CosmWasm/wasmd/app.Bech32Prefix=sepia \
		  -X github.com/CosmWasm/wasmd/app.NodeDir=.sepiad \
		  -X github.com/CosmWasm/wasmd/app.Bech32Prefix=sepia \
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/sepiad ./cmd/wasmd
endif
